import PracticeRoomBookingModal from "@/components/PracticeRoomBookingModal";
...
function Nav({ onBookClick, onPracticeRoomClick }: { onBookClick: () => void; onPracticeRoomClick: () => void }) {
        ...
        {expanded !== null && (
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <h3 className="font-display text-2xl" style={{ color: C.text, fontWeight: 500 }}>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Bio Section */}
              <div>
                <p style={{ color: C.accent, fontSize: "0.9rem", fontWeight: 600, letterSpacing: "0.05em", marginBottom: "1rem" }}>
              ...
              {/* Hire Musicians Form */}
              <HireMusiciansForm musician={faculty[expanded].name} />
            </div>
          </div>
        )}
      </div>
...
function Spaces({ onPracticeRoomClick }: { onPracticeRoomClick: () => void }) {
...
function Events() {
  ...
  const galleryItems = [
    // Performances
    {
      ...
      thumbnail: "https://d2xsxph8kpxj0f.cloudfront.net/310519663333334060/LSYMFpTaKgJ4fs4qHQmZSd/Firefly-Flute-3secondclip_thumb_c7a4c1fc.jpg",
    ...
    },
    {
      ...
      thumbnail: "https://d2xsxph8kpxj0f.cloudfront.net/310519663333334060/LSYMFpTaKgJ4fs4qHQmZSd/Firefly-Violin-3secondclip_thumb_a51bfb84.jpg",
    ...
    },
    {
      ...
      thumbnail: "https://d2xsxph8kpxj0f.cloudfront.net/310519663333334060/LSYMFpTaKgJ4fs4qHQmZSd/PianoInsides-3secondclip_thumb_5c55293d.jpg",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: C.bg }}>
      ...
      <Faculty />
      <Spaces onPracticeRoomClick={() => setPracticeRoomModalOpen(true)} />
      <PaymentInfo />
      <MembershipPlans />
      <Events />
